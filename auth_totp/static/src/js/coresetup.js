...
instance.web.Session = instance.web.JsonRPC.extend( /** @lends instance.web.Session# */{
    ...
    session_authenticate: function(db, login, password, totp_pin, _volatile) {
	// customized for TOTP login - end
        var self = this;
        var base_location = document.location.protocol + '//' + document.location.host;
		// customized for TOTP login - begin
        var params = { db: db, login: login, password: password, totp_pin: totp_pin, base_location: base_location };
		// customized for TOTP login - end
